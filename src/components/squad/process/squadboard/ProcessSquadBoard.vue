  ...
  <v-container class="container">
    ...
    <div class="container_squad_board_body">
      <div
        ...
        <div class="squad_board_body_create_button">
          <v-btn
            class="button_style"
      ...
      <div
        class="container_squad_board_body_fail"
        v-else>
        <div class="squad_board_body_fail_description">
          <p>생성된 스쿼드 게시글이 존재하지 않습니다.</p>
        </div>
        <div class="squad_board_body_create_button">
          <v-btn
            class="button_style"
...
export default {
  ...
  methods: {
    ...
    routeSquadBoard(squadBoardId) {
      ...
      this.$router.push(`/squad/${squadId}/squadboard/${squadBoardId}`);
    }
  },
  created() {
...
.container_squad_board_body_fail {
  height: 400px;
}

.squad_board_body_fail_description {
  height: 100%;
  display: flex;
  flex-direction: row;
...
.squad_board_body_create_button {
  display: flex;
