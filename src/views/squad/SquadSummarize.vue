<template>
  ...
  <div id="layout" >
    <div class="left-section">
      ...
      <v-btn block router to="/SquadBoard" class="left-button">SquadBoard</v-btn>
      <v-btn block router to="/SquadSummarize" class="left-button purple-button">Summarize</v-btn>
    </div>
